...
::===========================
	SET LINKV1=https://www.dropbox.com/scl/fi/s6h4gfa4gn7pdu1r4w26y/1.2.0.6.zip?rlkey=49bwatwz9jegmhiz4jikk150l&st=aqdc8bcu&dl=1
	SET VERSAOV1=1.2.0.6
