...
::===========================
	SET UF=PB
	SET LINKV1=https://www.dropbox.com/scl/fi/59txb6tjsbvw7fkw0jd02/1.6.0.1.zip?rlkey=mktnon5qtmt9ggfn5lm7594qk&st=ggn9bfqx&dl=1
	SET VERSAOV1=1.6.0.1
...
REM ******************* VERIFICA VERSAO ****************
	...
	timeout /t 1 >nul
::COPIA ARQUIVO CONFIG.INI
	robocopy "%temp%\Fenox" "C:\Program Files (x86)\Fenox V1.0" config.ini /MOV /NFL /NDL /NJH /NJS /NP
::EXECUTA V1
