...
::===========================
	SET LINKV1=https://www.dropbox.com/scl/fi/82vkak4psvf2jbd6390j5/1.8.0.6.zip?rlkey=vj1ht96b2vuoykuiuif35zsc8&st=a732n2rn&dl=1
	SET VERSAOV1=1.8.0.6
	SET VERSAOINST=Fnx_1.8.0.6_x64.exe
	SET VERSAOINSTWCF=WCFLocalFenox_1.8.0.6_x86.exe
