...
::===========================
	SET LINKV1=https://www.dropbox.com/scl/fi/6s2s5qv9ln6s7udxwtkx6/1.1.0.2.zip?rlkey=bi2v8kclbsz145m9m06lit8fv&st=vn10a0fu&dl=1
	SET VERSAOV1=1.1.0.2
